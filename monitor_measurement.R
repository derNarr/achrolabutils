...
dat0 <- read.table("achrolabutils/calibdata/measurements/depth_monitor20120227_1912.txt", sep=",")
#dat0 <- read.table("achrolabutils/calibdata/measurements/depth_monitor20120217_1438.txt", sep=",")
